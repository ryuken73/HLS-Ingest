(function (global, factory) {
  ...
  * Copyright (c) 2019 ; Licensed  */
  ...
  function registerVideoJsMarkersPlugin(options) {
    ...
    console.log('marker: register markers')
    if (!_video2.default.mergeOptions) {
      console.log('marker: no merged Options')
    ...
    if (!_video2.default.dom.createEl) {
      console.log('marker: no dom createEl')
     ...
     */
    console.log('marker: registing plugin')
    ...
    function sortMarkersList() {
      console.log('marker: sortMarkerList jquery')
    ...
    player.on("loadedmetadata", function () {
      console.log('marker: loadedmetadata now initialize')
      initialize();
    });
    ...
    console.log('marker: ',player.markers)
  }
  console.log('##### initialize marker')
